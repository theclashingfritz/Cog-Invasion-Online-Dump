...
# Embedded file name: xml.etree.ElementTree
__all__ = [
 'Comment',
 'dump',
 'Element', 'ElementTree',
...
class ElementTree(object):
    ...
    def write(self, file_or_filename, encoding=None, xml_declaration=None, default_namespace=None, method=None):
        ...
        if not encoding:
            ...
            if xml_declaration or xml_declaration is None and encoding not in ('utf-8',
                                                                               'us-ascii'):
                if method == 'xml':
    ...
    for elem in iterate():
        ...
        if isinstance(tag, QName):
            ...
            if isinstance(tag, basestring):
                ...
                if tag is not None and tag is not Comment and tag is not PI:
                ...
                if self._doctype is not None:
                    ...
                    if n > 2:
                        ...
                        if hasattr(self.target, 'doctype'):
                            ...
                            if self.doctype is not self.__doctype:
