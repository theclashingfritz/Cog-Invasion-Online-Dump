...
# Embedded file name: lib.coginvasion.nametag.NametagGroup
...
class NametagGroup:
        ...
        if NametagGlobals.forceOnscreenChat and chatText and self.chatBalloonType == NametagGlobals.CHAT_BALLOON:
            ...
            if self.avatar == NametagGlobals.me:
                ...
                if NametagGlobals.force2dNametags:
                    ...
                    if not NametagGlobals.want2dNametags and (not chatText or self.chatBalloonType != NametagGlobals.CHAT_BALLOON):
                        visible3d = True
                    else:
    ...
    def setChatText(self, chatText, timeout=False):
        if self.getChatText():
            ...
            self.stompTask = taskMgr.doMethodLater(self.CHAT_STOMP_DELAY, self.__chatStomp, self.stompTaskName, extraArgs=[
             timeout])
            return
        self.clearChatText()
        ...
        if timeout:
            ...
            if delay < self.CHAT_TIMEOUT_MIN:
                ...
                if delay > self.CHAT_TIMEOUT_MAX:
