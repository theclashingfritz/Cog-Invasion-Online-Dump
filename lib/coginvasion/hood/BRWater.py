...
class BRWater:
    ...
    def enterFrozen(self):
        ...
        self.powerBar = DirectWaitBar(frameColor=(1, 1, 1, 1), range=100, value=0, scale=(0.4,
                                                                                          0.5,
                                                                                          0.25), parent=self.frame, barColor=(0.55,
                                                                                                                              0.7,
                                                                                                                              1.0,
                                                                                                                              1.0))
        self.label = OnscreenText(text='SHAKE MOUSE', shadow=(0, 0, 0, 1), fg=(0.55,
                                                                               0.7,
                                                                               1.0,
                                                                               1.0), pos=(0,
                                                                                          -0.1,
