...
# Embedded file name: lib.coginvasion.hood.DistributedBuilding
...
class DistributedBuilding(DistributedObject):
    ...
    def enterWaitForVictors(self, ts):
        ...
        if victorCount == 1:
            ...
            if anyOthers:
                self.waitingMessage = DirectLabel(text='Waiting for other players...', text_fg=VBase4(1, 1, 1, 1), text_align=TextNode.ACenter, relief=None, pos=(0,
                                                                                                                                                                  0,
                                                                                                                                                                  0.35), scale=0.1, text_shadow=(0,
                                                                                                                                                                                                 0,
                                                                                                                                                                                                 0,
                                                                                                                                                                                                 1))
        else:
