...
nextShops = {'gender': 'body', 'body': 'color', 
   'color': 'cloth', 
   'cloth': 'name'}
prevShops = {'body': 'gender', 'color': 'body', 
   'cloth': 'color', 
   'name': 'cloth'}
...
class MakeAToon:
    ...
    def __init__(self):
        ...
        self.matFSM = ClassicFSM('MakeAToon', [
         ...
         State('genderShop', self.enterGenderShop, self.exitGenderShop, [
          'exit',
          'off',
          'bodyShop']),
         State('bodyShop', self.enterBodyShop, self.exitBodyShop, [
          'exit',
          'off',
          'genderShop',
          'colorShop']),
         State('colorShop', self.enterColorShop, self.exitColorShop, [
          'exit',
          'off',
          'bodyShop',
          'clothShop']),
         State('clothShop', self.enterClothShop, self.exitClothShop, [
          'exit',
          'off',
          'colorShop',
          'nameShop']),
         State('nameShop', self.enterNameShop, self.exitNameShop, [
          'exit',
          'off',
          'clothShop',
          'done']),
    ...
    def load(self):
        self.exitBtn = DirectButton(text=('', 'Exit', 'Exit', ''), text_scale=0.08, text_shadow=(0,
                                                                                                 0,
                                                                                                 0,
                                                                                                 1), text_fg=(1,
                                                                                                              1,
         ...
         self.mat_gui.find('**/tt_t_gui_mat_closeUp'),
         self.mat_gui.find('**/tt_t_gui_mat_closeUp')), geom3_color=(0.6, 0.6, 0.6,
                                                                     0.6), relief=None, pos=(0.2,
                                                                                             0.2,
                                                                                             0.2), geom0_scale=0.6, geom1_scale=0.65, geom2_scale=0.65, geom3_scale=0.6, command=self.__handleExit, extraArgs=[
         'quit'], parent=base.a2dBottomLeft)
        self.exitBtn.setBin('gui-popup', 60)
        self.okBtn = DirectButton(text=('', 'Ready', 'Ready', ''), text_scale=0.08, text_shadow=(0,
                                                                                                 0,
                                                                                                 0,
                                                                                                 1), text_fg=(1,
                                                                                                              1,
         ...
         self.mat_gui.find('**/tt_t_gui_mat_okUp'),
         self.mat_gui.find('**/tt_t_gui_mat_okUp')), geom3_color=(0.6, 0.6, 0.6, 0.6), relief=None, pos=(-0.2,
                                                                                                         0.2,
                                                                                                         0.2), geom0_scale=0.6, geom1_scale=0.65, geom2_scale=0.65, geom3_scale=0.6, command=self.finishedMakeAToon, parent=base.a2dBottomRight)
        self.okBtn.hide()
        self.okBtn.setBin('gui-popup', 60)
        self.nextBtn = DirectButton(text=('', 'Next', 'Next', ''), text_scale=0.08, text_shadow=(0,
                                                                                                 0,
                                                                                                 0,
                                                                                                 1), text_fg=(1,
                                                                                                              1,
         ...
         self.mat_gui.find('**/tt_t_gui_mat_nextUp'),
         self.mat_gui.find('**/tt_t_gui_mat_nextDisabled')), relief=None, pos=(-0.2,
                                                                               0.2,
                                                                               0.2), geom0_scale=0.3, geom1_scale=0.35, geom2_scale=0.35, geom3_scale=0.3, command=self.__handleNextShop, parent=base.a2dBottomRight)
        self.nextBtn.setBin('gui-popup', 60)
        self.backBtn = DirectButton(text=('', 'Back', 'Back', ''), text_scale=0.08, text_shadow=(0,
                                                                                                 0,
                                                                                                 0,
                                                                                                 1), text_fg=(1,
                                                                                                              1,
         ...
         self.mat_gui.find('**/tt_t_gui_mat_nextDown'),
         self.mat_gui.find('**/tt_t_gui_mat_nextUp'),
         self.mat_gui.find('**/tt_t_gui_mat_nextDisabled')), relief=None, pos=(-0.4,
                                                                               0.2,
                                                                               0.2), geom3_color=Vec4(0.5, 0.5, 0.5, 0.75), geom0_scale=(-0.3,
                                                                                                                                         0.3,
                                                                                                                                         0.3), geom1_scale=(-0.35,
                                                                                                                                                            0.35,
                                                                                                                                                            0.35), geom2_scale=(-0.35,
                                                                                                                                                                                0.35,
                                                                                                                                                                                0.35), geom3_scale=(-0.3,
                                                                                                                                                                                                    0.3,
                                                                                                                                                                                                    0.3), command=self.__handlePrevShop, parent=base.a2dBottomRight)
    ...
    def enterGenderShop(self):
        ...
        self.boyBtn = DirectButton(text=('', 'Boy', 'Boy', ''), text_scale=0.08, text_shadow=(0,
                                                                                              0,
                                                                                              0,
                                                                                              1), text_fg=(1,
                                                                                                           1,
         ...
         self.mat_gui.find('**/tt_t_gui_mat_boyUp'),
         self.mat_gui.find('**/tt_t_gui_mat_boyDown')), relief=None, pos=(-0.45, -0.8,
                                                                          -0.8), geom0_scale=0.6, geom1_scale=0.7, geom2_scale=0.7, geom3_scale=0.6, command=self.generateToon, extraArgs=[
         'boy'])
        self.girlBtn = DirectButton(text=('', 'Girl', 'Girl', ''), text_scale=0.08, text_shadow=(0,
                                                                                                 0,
                                                                                                 0,
                                                                                                 1), text_fg=(1,
                                                                                                              1,
         ...
         self.mat_gui.find('**/tt_t_gui_mat_girlUp'),
         self.mat_gui.find('**/tt_t_gui_mat_girlDown')), relief=None, pos=(0.45, -0.8,
                                                                           -0.8), geom0_scale=0.6, geom1_scale=0.7, geom2_scale=0.7, geom3_scale=0.6, command=self.generateToon, extraArgs=[
         'girl'])
    ...
    def enterBodyShop(self):
        ...
        self.nextHeadBtn = DirectButton(text='Head', text_scale=0.06, text_fg=(1, 0,
                                                                               0,
                                                                               1), text_pos=(-0.03,
                                                                                             0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom3_color=(0.6, 0.6, 0.6, 0.6), relief=None, pos=(0.45,
                                                                                                         0.1,
                                                                                                         0.1), command=self.nextHead)
        self.prevHeadBtn = DirectButton(text='Head', text_scale=0.06, text_fg=(1, 0,
                                                                               0,
                                                                               1), text_pos=(0.03,
                                                                                             0.005), geom=(
         self.cat_gui.find('**/CrtATn_R_Arrow_UP'),
         self.cat_gui.find('**/CrtATn_R_Arrow_DN'),
         self.cat_gui.find('**/CrtATn_R_Arrow_RLVR'),
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom_scale=(-1, 1, 1), geom3_color=(0.6,
                                                                                         0.6,
                                                                                         0.6,
                                                                                         0.6), relief=None, pos=(-0.5,
                                                                                                                 0.1,
                                                                                                                 0.1), command=self.prevHead)
        self.nextTorsoBtn = DirectButton(text='Body', text_scale=0.06, text_fg=(1,
                                                                                0,
                                                                                0,
                                                                                1), text_pos=(-0.03,
                                                                                              0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom3_color=(0.6, 0.6, 0.6, 0.6), relief=None, pos=(0.45,
                                                                                                         -0.2,
                                                                                                         -0.2), command=self.nextTorso)
        self.prevTorsoBtn = DirectButton(text='Body', text_scale=0.06, text_fg=(1,
                                                                                0,
                                                                                0,
                                                                                1), text_pos=(0.03,
                                                                                              0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom_scale=(-1, 1, 1), geom3_color=(0.6,
                                                                                         ...
                                                                                         0.6), relief=None, pos=(-0.5,
                                                                                                                 -0.2,
                                                                                                                 -0.2), command=self.prevTorso)
        self.nextLegBtn = DirectButton(text='Legs', text_scale=0.06, text_fg=(1, 0,
                                                                              0,
                                                                              1), text_pos=(-0.03,
                                                                                            0.005), geom=(
         self.cat_gui.find('**/CrtATn_R_Arrow_UP'),
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom3_color=(0.6, 0.6, 0.6, 0.6), relief=None, pos=(0.45,
                                                                                                         -0.5,
                                                                                                         -0.5), command=self.nextLeg)
        self.prevLegBtn = DirectButton(text='Legs', text_scale=0.06, text_fg=(1, 0,
                                                                              0,
                                                                              1), text_pos=(0.03,
                                                                                            0.005), geom=(
         self.cat_gui.find('**/CrtATn_R_Arrow_UP'),
    ...
    def updateBodyShopButtons(self):
        if self.currentHead == '2' and self.toonGen.toon.animal == 'cat':
            ...
            if self.currentHead == '4' and self.toonGen.toon.animal == 'duck':
                self.nextHeadBtn['state'] = DGG.DISABLED
            else:
                if self.currentHead == '1' and self.toonGen.toon.animal == 'cat':
                    self.prevHeadBtn['state'] = DGG.DISABLED
                else:
                    if self.currentHead == '3' and self.toonGen.toon.animal == 'duck':
        ...
        if self.currentTorso == 'dgm_shorts' and self.toonGen.toon.gender == 'boy' or self.currentTorso == 'dgm_skirt' and self.toonGen.toon.gender == 'girl':
            ...
            if self.currentTorso == 'dgl_shorts' and self.toonGen.toon.gender == 'boy' or self.currentTorso == 'dgl_skirt' and self.toonGen.toon.gender == 'girl':
                self.nextTorsoBtn['state'] = DGG.DISABLED
            else:
                if self.currentTorso == 'dgs_shorts' and self.toonGen.toon.gender == 'boy' or self.currentTorso == 'dgs_skirt' and self.toonGen.toon.gender == 'girl':
        ...
        if self.currentLeg == 'dgm':
            ...
            if self.currentLeg == 'dgl':
                self.nextLegBtn['state'] = DGG.DISABLED
            else:
                if self.currentLeg == 'dgs':
    ...
    def enterColorShop(self):
        ...
        self.nextAllColorBtn = DirectButton(text='Toon', text_scale=0.06, text_fg=(1,
                                                                                   0,
                                                                                   0,
                                                                                   1), text_pos=(-0.03,
                                                                                                 0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom_scale=(1, 1, 1), geom3_color=(0.6,
                                                                                        0.6,
                                                                                        0.6,
                                                                                        0.6), relief=None, scale=1.3, pos=(0.45,
                                                                                                                           0.5,
                                                                                                                           0.5), command=self.nextAllColor)
        self.prevAllColorBtn = DirectButton(text='Toon', text_scale=0.06, text_fg=(1,
                                                                                   0,
                                                                                   0,
                                                                                   1), text_pos=(0.03,
                                                                                                 0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom_scale=(-1, 1, 1), geom3_color=(0.6,
                                                                                         0.6,
                                                                                         0.6,
                                                                                         0.6), relief=None, scale=1.3, pos=(-0.5,
                                                                                                                            0.5,
                                                                                                                            0.5), command=self.prevAllColor)
        self.nextHeadColorBtn = DirectButton(text='Head', text_scale=0.06, text_fg=(1,
                                                                                    0,
                                                                                    0,
                                                                                    1), text_pos=(-0.03,
                                                                                                  0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom3_color=(0.6, 0.6, 0.6, 0.6), relief=None, pos=(0.45,
                                                                                                         0.1,
                                                                                                         0.1), command=self.nextHeadColor)
        self.prevHeadColorBtn = DirectButton(text='Head', text_scale=0.06, text_fg=(1,
                                                                                    0,
                                                                                    0,
                                                                                    1), text_pos=(0.03,
                                                                                                  0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom_scale=(-1, 1, 1), geom3_color=(0.6,
                                                                                         ...
                                                                                         0.6), relief=None, pos=(-0.5,
                                                                                                                 0.1,
                                                                                                                 0.1), command=self.prevHeadColor)
        self.nextTorsoColorBtn = DirectButton(text='Body', text_scale=0.06, text_fg=(1,
                                                                                     0,
                                                                                     0,
                                                                                     1), text_pos=(-0.03,
                                                                                                   0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom3_color=(0.6, 0.6, 0.6, 0.6), relief=None, pos=(0.45,
                                                                                                         -0.2,
                                                                                                         -0.2), command=self.nextTorsoColor)
        self.prevTorsoColorBtn = DirectButton(text='Body', text_scale=0.06, text_fg=(1,
                                                                                     0,
                                                                                     0,
                                                                                     1), text_pos=(0.03,
                                                                                                   0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom_scale=(-1, 1, 1), geom3_color=(0.6,
                                                                                         ...
                                                                                         0.6), relief=None, pos=(-0.5,
                                                                                                                 -0.2,
                                                                                                                 -0.2), command=self.prevTorsoColor)
        self.nextLegColorBtn = DirectButton(text='Legs', text_scale=0.06, text_fg=(1,
                                                                                   0,
                                                                                   0,
                                                                                   1), text_pos=(-0.03,
                                                                                                 0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom3_color=(0.6, 0.6, 0.6, 0.6), relief=None, pos=(0.45,
                                                                                                         -0.5,
                                                                                                         -0.5), command=self.nextLegColor)
        self.prevLegColorBtn = DirectButton(text='Legs', text_scale=0.06, text_fg=(1,
                                                                                   0,
                                                                                   0,
                                                                                   1), text_pos=(0.03,
                                                                                                 0.005), geom=(
    ...
    def updateColorShopButtons(self):
        ...
        if self.toonGen.toon.color2colorDNA[self.currentColor] == '01':
            ...
            if self.toonGen.toon.color2colorDNA[self.currentColor] == '26':
                ...
                if self.toonGen.toon.color2colorDNA[self.currentColor] == '00':
                    ...
                    if self.toonGen.toon.color2colorDNA[self.currentColor] == '25':
                        self.nextAllColorBtn['state'] = DGG.NORMAL
                        self.nextHeadColorBtn['state'] = DGG.NORMAL
                        self.nextTorsoColorBtn['state'] = DGG.NORMAL
                        self.nextLegColorBtn['state'] = DGG.NORMAL
    ...
    def enterClothShop(self):
        ...
        self.nextShirtBtn = DirectButton(text='Shirt', text_scale=0.06, text_fg=(1,
                                                                                 0,
                                                                                 0,
                                                                                 1), text_pos=(-0.03,
                                                                                               0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom3_color=(0.6, 0.6, 0.6, 0.6), relief=None, pos=(0.45,
                                                                                                         -0.2,
                                                                                                         -0.2), command=self.nextShirt)
        self.prevShirtBtn = DirectButton(text='Shirt', text_scale=0.06, text_fg=(1,
                                                                                 0,
                                                                                 0,
                                                                                 1), text_pos=(0.03,
                                                                                               0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom_scale=(-1, 1, 1), geom3_color=(0.6,
                                                                                         ...
                                                                                         0.6), relief=None, pos=(-0.5,
                                                                                                                 -0.2,
                                                                                                                 -0.2), command=self.prevShirt)
        self.nextShortsBtn = DirectButton(text='Shorts', text_scale=0.06, text_fg=(1,
                                                                                   0,
                                                                                   0,
                                                                                   1), text_pos=(-0.03,
                                                                                                 0.005), geom=(
         ...
         self.cat_gui.find('**/CrtATn_R_Arrow_UP')), geom3_color=(0.6, 0.6, 0.6, 0.6), relief=None, pos=(0.45,
                                                                                                         -0.5,
                                                                                                         -0.5), command=self.nextShorts)
        self.prevShortsBtn = DirectButton(text='Shorts', text_scale=0.06, text_fg=(1,
                                                                                   0,
                                                                                   0,
                                                                                   1), text_pos=(0.03,
                                                                                                 0.005), geom=(
    ...
    def setTitle(self, title, color):
        ...
        self.title_lbl = DirectLabel(text=title, relief=None, text_scale=0.16, text_font=loader.loadFont('phase_3/models/fonts/MickeyFont.bam'), pos=(0,
                                                                                                                                                      0.85,
                                                                                                                                                      0.85))
        if color == 'yellow':
            ...
            if color == 'sea-green':
                self.title_lbl['text_fg'] = (0, 0.8509803921568627, 0.4784313725490196,
                                             1)
            else:
                if color == 'light-blue':
