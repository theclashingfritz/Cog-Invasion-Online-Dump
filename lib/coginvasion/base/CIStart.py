...
from panda3d.core import Thread, loadPrcFile, loadPrcFileData, CollisionTraverser, CullBinManager, NodePath
from panda3d.core import ConfigVariableDouble
from direct.extensions_native.CInterval_extensions import *
from direct.extensions_native.HTTPChannel_extensions import *
from direct.extensions_native.Mat3_extensions import *
from direct.extensions_native.NodePath_extensions import *
from direct.extensions_native.VBase3_extensions import *
from direct.extensions_native.VBase4_extensions import *
import __builtin__, os, sys
if hasattr(NodePath, 'DtoolClassDict'):
    for dtool in ('children', 'parent', 'name'):
        if dtool in NodePath.DtoolClassDict:
            del NodePath.DtoolClassDict[dtool]

vfs = VirtualFileSystem.getGlobalPtr()
phases = [
 'phase_3', 'phase_3.5', 'phase_4', 'phase_5', 'phase_5.5', 'phase_6', 'phase_7', 'phase_8', 'phase_9',
