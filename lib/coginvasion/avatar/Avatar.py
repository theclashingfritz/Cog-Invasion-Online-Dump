...
class Avatar(ToonTalker.ToonTalker, Actor):
    ...
    def setupNameTag(self, tempName=None):
        ...
        if self.avatarType == CIGlobals.Toon:
            ...
            if self.avatarType == CIGlobals.Suit or self.avatarType == CIGlobals.CChar:
    ...
    def loopFromFrameToZero(self, animName, restart=1, partName=None, fromFrame=None):
        ...
        if hasattr(self, 'cr'):
            ...
            taskName = 'loopTask'
        taskMgr.doMethodLater(dur, self.loopTask, taskName, extraArgs=[
         animName, restart, partName], appendTask=True)
