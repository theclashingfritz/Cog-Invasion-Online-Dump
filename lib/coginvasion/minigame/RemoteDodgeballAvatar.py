...
# Embedded file name: lib.coginvasion.minigame.RemoteDodgeballAvatar
...
class RemoteDodgeballAvatar(RemoteAvatar):
    ...
    def unFreeze(self):
        ...
        self.freezeDnTrack = Sequence(Parallel(SoundInterval(self.iceCubeBreak, node=self.iceCube), LerpColorScaleInterval(self.iceCube, duration=0.5, colorScale=VBase4(0.76, 0.76, 1.0, 0.0), startColorScale=self.iceCube.getColorScale(), blendType='easeInOut'), LerpColorScaleInterval(self.avatar.getGeomNode(), duration=0.5, colorScale=VBase4(1.0, 1.0, 1.0, 1.0), startColorScale=base.localAvatar.getGeomNode().getColorScale(), blendType='easeOut')), Func(self.iceCube.reparentTo, self.avatar), Func(self.iceCube.setPosHpr, 0, 0, 0, 0, 0, 0))
    ...
    def freeze(self):
        ...
        self.avatar.stop()
        self.freezeUpTrack = Parallel(SoundInterval(self.iceCubeForm, node=self.iceCube), LerpColorScaleInterval(self.iceCube, duration=0.5, colorScale=VBase4(0.76, 0.76, 1.0, 1.0), startColorScale=self.iceCube.getColorScale(), blendType='easeInOut'), LerpColorScaleInterval(self.avatar.getGeomNode(), duration=0.5, colorScale=VBase4(0.5, 0.5, 1.0, 1.0), startColorScale=base.localAvatar.getGeomNode().getColorScale(), blendType='easeOut'))
