...
def getIval(text, duration1, duration2, duration3):
    ival = Sequence(LerpPosInterval(text, duration=duration1, pos=(0, 0, 0.5), startPos=(0,
                                                                                         0,
                                                                                         1.7), blendType='easeIn'), LerpPosInterval(text, duration=duration2, pos=(0.0,
                                                                                                                                                                   0,
                                                                                                                                                                   0), startPos=(0,
                                                                                                                                                                                 0,
                                                                                                                                                                                 0.5)), LerpPosInterval(text, duration=duration3, pos=(0,
                                                                                                                                                                                                                                       0,
                                                                                                                                                                                                                                       -1.3), startPos=(0,
                                                                                                                                                                                                                                                        0,
                                                                                                                                                                                                                                                        0), blendType='easeOut'))
...
class DistributedEagleGame(DistributedMinigame):
    ...
    def __init__(self, cr):
        ...
        self.cannonFSM = ClassicFSM('Cannon', [
         ...
         State('fly', self.enterFly, self.exitFly)], 'off', 'off')
    ...
    def enterFly(self):
        ...
        self.flyProjectile = FlightProjectileInterval(base.localAvatar, startPos=cannon.find(self.cannonBarrel).getPos(render) + (0,
                                                                                                                                  5.0,
                                                                                                                                  0), endPos=dummyNode.getPos(render), duration=5.0, name='DEagleGame-localAvatarFly', gravityMult=0.25)
