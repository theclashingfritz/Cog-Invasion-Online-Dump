...
class FactorySneakWorld(DirectObject):
    ...
    def showAlert(self, text):
        ...
        self.alertPulse = Sequence(LerpFunc(change_text_scale, duration=0.3, toData=0.12, fromData=0.01, blendType='easeOut'), LerpFunc(change_text_scale, duration=0.2, toData=0.1, fromData=0.12, blendType='easeInOut'), Wait(1.5), Func(self.alertText.setText, ''))
    ...
    def loadWorld(self):
        ...
        self.alertText = OnscreenText(text='', font=CIGlobals.getMickeyFont(), fg=(1,
                                                                                   0.9,
                                                                                   0.3,
                                                                                   1), pos=(0,
                                                                                            0.8,
