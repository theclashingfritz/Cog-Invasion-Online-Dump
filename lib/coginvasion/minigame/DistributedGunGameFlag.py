...
# Embedded file name: lib.coginvasion.minigame.DistributedGunGameFlag
...
class DistributedGunGameFlag(DistributedNode):
    ...
    torsoType2flagY = {'dgs_shorts': -1.5, 'dgs_skirt': -1.5, 'dgm_shorts': -1.1, 'dgm_skirt': -1.1, 
       'dgl_shorts': -1.1, 'dgl_skirt': -1.1}
    ...
    def startPulse(self):
        ...
        self.pulseIval = Sequence(LerpScaleInterval(frame, duration=0.5, scale=Vec3(0.6, 0.6, 0.6), startScale=Vec3(1, 1, 1), blendType='easeInOut'), LerpScaleInterval(frame, duration=0.5, scale=Vec3(1, 1, 1), startScale=Vec3(0.6, 0.6, 0.6), blendType='easeInOut'))
        self.pulseIval.loop()
