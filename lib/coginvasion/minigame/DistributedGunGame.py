...
import GunGameLevelLoader, GunGameGlobals as GGG, random, math

class DistributedGunGame(DistributedToonFPSGame, TeamMinigame):
    notify = directNotify.newCategory('DistributedGunGame')
    GameMode2Description = {GGG.GameModes.CASUAL: 'Battle and defeat the Toons on the other team with your gun to gain points. ' + "Remember to reload your gun when you're out of ammo! " + 'The Toon with the most points when the timer runs out gets a nice prize!', 
    ...
    GameMode2Music = {GGG.GameModes.CASUAL: 'phase_4/audio/bgm/MG_TwoDGame.mid', GGG.GameModes.CTF: 'phase_9/audio/bgm/CHQ_FACT_bg.mid', 
    ...
    def __init__(self, cr):
        ...
        TeamMinigame.__init__(self, GGG.BLUE, ('phase_4/maps/blue_neutral.png', 'phase_4/maps/blue_hover.png',
                                               'phase_4/maps/blue_hover.png'), GGG.RED, ('phase_4/maps/red_neutral.png',
    ...
    def enterVoteGameMode(self):
        ...
        self.bg = OnscreenImage(image=box, color=(1, 1, 0.75, 1), scale=(2.4, 1.4,
                                                                         1.4), parent=self.container)
        self.title = OnscreenText(text='Vote  on  Game  Mode', pos=(0, 0.5, 0), font=font, scale=0.12, parent=self.container, fg=(1,
                                                                                                                                  0.9,
                                                                                                                                  0.3,
                                                                                                                                  1))
        self.btnFrame = DirectFrame(parent=self.container, pos=(0.14, 0, 0))
        self.casualFrame = DirectFrame(parent=self.btnFrame, pos=(-0.8, 0, 0))
        self.ctfFrame = DirectFrame(parent=self.btnFrame, pos=(-0.125, 0, 0))
        self.kothFrame = DirectFrame(parent=self.btnFrame, pos=(0.55, 0, 0))
        self.casual = DirectButton(parent=self.casualFrame, relief=None, pressEffect=0, image=('phase_4/maps/casual_neutral.png',
                                                                                               'phase_4/maps/casual_hover.png',
                                                                                               'phase_4/maps/casual_hover.png'), image_scale=(0.9,
                                                                                                                                              1,
                                                                                                                                              1), scale=0.4, command=self.__pickedGameMode, extraArgs=[GGG.GameModes.CASUAL])
        self.casual_votesLbl = OnscreenText(parent=self.casualFrame, text='0', pos=(0,
                                                                                    -0.46,
                                                                                    0), font=imp)
        self.ctf = DirectButton(parent=self.ctfFrame, relief=None, pressEffect=0, image=('phase_4/maps/ctf_neutral.png',
                                                                                         'phase_4/maps/ctf_hover.png',
                                                                                         'phase_4/maps/ctf_hover.png'), image_scale=(0.9,
                                                                                                                                     1,
                                                                                                                                     1), scale=0.4, command=self.__pickedGameMode, extraArgs=[GGG.GameModes.CTF])
        self.ctf_votesLbl = OnscreenText(parent=self.ctfFrame, text='0', pos=(0, -0.46,
                                                                              0), font=imp)
        self.koth = DirectButton(parent=self.kothFrame, relief=None, pressEffect=0, image=('phase_4/maps/koth_neutral.png',
                                                                                           'phase_4/maps/koth_hover.png',
                                                                                           'phase_4/maps/koth_hover.png'), image_scale=(0.9,
                                                                                                                                        1,
                                                                                                                                        1), scale=0.4, command=self.__pickedGameMode, extraArgs=[GGG.GameModes.KOTH])
        self.koth_votesLbl = OnscreenText(parent=self.kothFrame, text='0', pos=(0,
                                                                                -0.46,
                                                                                0), font=imp)
        self.outcomeLbl = OnscreenText(parent=self.container, text='', pos=(0, -0.6,
                                                                            0), font=imp, scale=0.1)
        return
    ...
    def enterChooseGun(self):
        ...
        self.pistolBtn = DirectButton(geom=geom, text='Pistol', relief=None, text_scale=0.055, text_pos=(0,
                                                                                                         -0.01), command=self.__gunChoice, extraArgs=['pistol'], pos=(0,
                                                                                                                                                                      0,
                                                                                                                                                                      0.35), parent=self.container)
        self.shotgunBtn = DirectButton(geom=geom, text='Shotgun', relief=None, text_scale=0.055, text_pos=(0,
                                                                                                           -0.01), command=self.__gunChoice, extraArgs=['shotgun'], pos=(0,
                                                                                                                                                                         0,
                                                                                                                                                                         0.25), parent=self.container)
        self.sniperBtn = DirectButton(geom=geom, text='Sniper', relief=None, text_scale=0.055, text_pos=(0,
                                                                                                         -0.01), command=self.__gunChoice, extraArgs=['sniper'], pos=(0,
                                                                                                                                                                      0,
                                                                                                                                                                      0.15), parent=self.container)
        return
    ...
    def enterCountdown(self):
        ...
        if self.gameMode == GGG.GameModes.CTF:
            ...
            self.blueScoreLbl = OnscreenText(text='Blue: 0', scale=0.1, parent=self.blueFrame, fg=GGG.TeamColorById[GGG.Teams.BLUE], shadow=(0,
                                                                                                                                             0,
                                                                                                                                             0,
                                                                                                                                             1), align=TextNode.ARight)
            ...
            self.redScoreLbl = OnscreenText(text='Red: 0', scale=0.1, parent=self.redFrame, fg=GGG.TeamColorById[GGG.Teams.RED], shadow=(0,
                                                                                                                                         0,
                                                                                                                                         0,
                                                                                                                                         1), align=TextNode.ALeft)
            ...
            self.infoLbl = OnscreenText(text='Playing to: 3', scale=0.1, pos=(0, -0.95), fg=(1,
                                                                                             1,
                                                                                             1,
                                                                                             1), shadow=(0,
                                                                                                         0,
        ...
        text = OnscreenText(text='', scale=0.1, pos=(0, 0.5), fg=(1, 1, 1, 1), shadow=(0,
                                                                                       0,
                                                                                       0,
                                                                                       1))
    ...
    def announceGenerate(self):
        ...
        base.localAvatar.walkControls.setWalkSpeed(GGG.ToonForwardSpeed, GGG.ToonJumpForce, GGG.ToonReverseSpeed, GGG.ToonRotateSpeed)
        self.load()
