...
class DistributedCameraShyGame(DistributedMinigame):
    ...
    def getPlayByPlayText(self):
        return OnscreenText(text='', fg=(1, 1, 1, 1), shadow=(0, 0, 0, 1), pos=(0,
                                                                                0.75))
    ...
    def enterShowWinner(self, winnerId):
        ...
        avatar.detachCamera()
        self.thisPlayerWinsLbl = OnscreenText(text=('{0} Wins!').format(avatar.avatar.getName()), fg=(1,
                                                                                                      1,
                                                                                                      1,
                                                                                                      1), font=CIGlobals.getMinnieFont(), pos=(0,
                                                                                                                                               0.8), scale=0.1)
