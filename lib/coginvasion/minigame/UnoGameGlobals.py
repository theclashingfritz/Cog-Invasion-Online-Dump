...
CARD_YELLOW = 80
CARD_GREEN = 90
colorId2colorName = {str(CARD_BLUE): 'Blue', str(CARD_GREEN): 'Green', 
   str(CARD_RED): 'Red', 
...
def addRandomColorToCardType(card_type):
    wildCards = [
     str(CARD_WILD), str(CARD_WILD_DRAW_FOUR)]
...
cardId = [
 str(CARD_DRAW_TWO) + str(CARD_BLUE),
...
DRAW_CARD_DECK_DATA = {cardId[0]: 2, 
   ...
   cardId[52]: 2, 
   cardId[53]: 2}
cardTex2cardId = {'mg_uno_actioncards_blue_drawtwo': cardId[0], 'mg_uno_actioncards_green_drawtwo': cardId[1], 
