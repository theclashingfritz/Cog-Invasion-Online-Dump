...
class HeadPanels:
    ...
    def generate(self, gender, head, headtype, color, doId, name, valueLabel=1):
        ...
        nameLbl = DirectLabel(text=name, text_wordwrap=7.0, parent=container, text_scale=0.13, text_fg=(1,
                                                                                                        1,
                                                                                                        1,
                                                                                                        1), text_shadow=(0,
                                                                                                                         0,
                                                                                                                         ...
                                                                                                                         1), relief=None, pos=(0,
                                                                                                                                               ...
                                                                                                                                               0.25))
        if valueLabel:
            someValueToBroadcast = DirectLabel(text='0', parent=container, text_scale=0.15, text_fg=(1,
                                                                                                     1,
                                                                                                     1,
                                                                                                     1), text_shadow=(0,
                                                                                                                      0,
                                                                                                                      0,
                                                                                                                      1), relief=None, pos=(0.26,
                                                                                                                                            0,
                                                                                                                                            -0.28))
