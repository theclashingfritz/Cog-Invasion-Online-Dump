...
class CameraShyFirstPerson(FirstPerson):
    ...
    def __init__(self, mg):
        ...
        self.camFSM = ClassicFSM('CameraFSM', [
         ...
         State('recharge', self.enterCameraRecharge, self.exitCameraRecharge)], 'off', 'off')
    ...
    def start(self):
        ...
        self.batteryFrame = DirectFrame(parent=base.a2dBottomRight, pos=(-0.2, 0, 0.1), scale=(0.8,
                                                                                               0,
                                                                                               1))
        ...
        self.batteryBar = DirectWaitBar(value=0, range=5, barColor=(1, 1, 1, 1), relief=None, scale=(0.12,
                                                                                                     0.0,
                                                                                                     0.3), parent=self.batteryFrame)
