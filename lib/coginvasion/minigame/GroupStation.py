...
class GroupStation(NodePath):
    ...
    def __init__(self):
        ...
        self.circle_pos = {3: {1: (-7, 10, 0.05), 2: (0, 10, 0.05), 
               3: (7, 10, 0.05)}, 
           4: {1: (-10.5, 10, 0.05), 2: (-3.5, 10, 0.05), 
               3: (3.5, 10, 0.05), 
               4: (10.5, 10, 0.05)}, 
           8: {1: (-10.5, 10, 0.05), 2: (-3.5, 10, 0.05), 
               3: (3.5, 10, 0.05), 
               4: (10.5, 10, 0.05), 
               5: (-10.5, 15, 0.05), 
               6: (-3.5, 15, 0.05), 
    ...
    def createTimer(self):
        self.time = 10
        self.timer = DirectLabel(text=str(self.time), relief=None, text_font=CIGlobals.getMickeyFont(), text_scale=1.5, pos=(0,
                                                                                                                             0,
                                                                                                                             5.1), text_fg=(1,
                                                                                                                                            0,
                                                                                                                                            0,
                                                                                                                                            1), text_decal=True, parent=self.sign)
