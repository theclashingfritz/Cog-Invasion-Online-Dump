...
class SuitTournament:
    ...
    round_difficulties = [range(1, 5),
     range(5, 9),
     range(9, 13)]
    round_sizes = [25,
     25,
     25]
    round_dialogue = {1: {'end': "That's all the " + CIGlobals.Suits + ' of round one. The ' + CIGlobals.Suits + ' are recharging and upgrading their parts...'}, 2: {'start': 'This is the second round of the ' + CIGlobals.Suit + ' Tournament, the more advanced ' + CIGlobals.Suits + ' are arriving.', 'end': "That's all for round two, prepare for the most advanced " + CIGlobals.Suits + ' to arrive.'}, 
       3: {'start': 'This is the third and deciding round! Defeat all the ' + CIGlobals.Suits + ' to stop them!', 'end': 'You fought off all of the ' + CIGlobals.Suits + '! Good job!'}, 
       4: {'start': "You've fought off all of the " + CIGlobals.Suits + '. However, the ' + CIGlobals.Suit + ' who defeated the most Toons won the prize of Vice President of ' + CIGlobals.Suits + '!', 'end': "Wow, great job fighting off the Vice President! I don't think we'll be seeing him again."}}
    BACKUP_INTERVAL = 150.0
    INITIAL_BACKUP_INTERVAL = 40.0
    backup_levels = {1: range(1, 5), 2: range(5, 9), 
       3: range(9, 13)}
