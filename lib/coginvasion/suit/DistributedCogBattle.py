...
class DistributedCogBattle(DistributedObject):
    ...
    DNCData = {0: [
         [
          (-50, 98.73, 0.4), (351.31, 0.0, 0.0), 1.25],
         [
    ...
    def __init__(self, cr):
        ...
        self.getBeansLabel = OnscreenText(text='Hurry and pick up all of the jellybeans!', fg=(1,
                                                                                               1,
                                                                                               1,
                                                                                               1), shadow=(0,
                                                                                                           0,
                                                                                                           0,
                                                                                                           1), pos=(0,
                                                                                                                    0.7), font=CIGlobals.getMinnieFont())
    ...
    def getBeansTimeUp(self):
        ...
        requestStatus = {'zoneId': zoneId, 'hoodId': hoodId, 
           'where': 'playground', 
    ...
    def createInterface(self):
        self.cogProgressBar = DirectWaitBar(pos=(0, 0, -0.9), relief=DGG.RAISED, scale=0.6, frameColor=(1,
                                                                                                        0.5,
                                                                                                        0.3,
                                                                                                        0.75), barColor=(1,
                                                                                                                         0.25,
                                                                                                                         0.25,
                                                                                                                         0.5), value=0, range=self.getTotalCogs(), text='', text_scale=0.08)
        self.__updateProgressBar()
