...
# Embedded file name: lib.coginvasion.cogoffice.ElevatorConstants
...
ElevatorData = {ELEVATOR_NORMAL: {'openTime': 2.0, 'closeTime': 2.0, 
                     ...
                     'sfxVolume': 1.0, 
                     'collRadius': 5}, 
   ELEVATOR_INT: {'openTime': 2.0, 'closeTime': 2.0, 
                  'width': 3.5, 
                  'countdown': 65.0, 
                  'sfxVolume': 1.0, 
                  'collRadius': 5}}
...
ElevatorPoints = [
 Point3(-1.5, 5, 0.1), Point3(1.5, 5, 0.1),
 Point3(-2.5, 3, 0.1), Point3(2.5, 3, 0.1)]
ElevatorOutPoints = [
 Point3(-1.5, -5, 0), Point3(1.5, -5, 0),
