...
class ThrowGag(Gag):
    ...
    def setAvatar(self, avatar):
        ...
        if self.isLocal():
            self.powerBar = DirectWaitBar(range=150, frameColor=(1, 1, 1, 1), barColor=(0.286,
                                                                                        0.901,
                                                                                        1,
                                                                                        1), relief=DGG.RAISED, borderWidth=(0.04,
                                                                                                                            0.04), pos=(0,
                                                                                                                                        0,
                                                                                                                                        0.85), scale=0.2, hpr=(0,
                                                                                                                                                               0,
                                                                                                                                                               0), parent=aspect2d, frameSize=(-0.85,
                                                                                                                                                                                               0.85,
                                                                                                                                                                                               -0.12,
                                                                                                                                                                                               0.12))
            self.powerBar.hide()
    ...
    def cleanupEntity(self, pos):
        ...
        for pieHash in pieHash2range.keys():
            ...
            if distance is not None and distance == ranges[0]:
                for entity, track in self.entities:
        ...
        if closestPie != None and trackOfClosestPie != None:
            if [
             closestPie, trackOfClosestPie] in self.entities:
