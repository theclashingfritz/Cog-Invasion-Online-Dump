...
import types
gagIds = {0: CIGlobals.WholeCreamPie, 1: CIGlobals.CreamPieSlice, 2: CIGlobals.BirthdayCake, 3: CIGlobals.TNT, 4: CIGlobals.SeltzerBottle, 
   5: CIGlobals.WholeFruitPie, 6: CIGlobals.WeddingCake, 7: CIGlobals.FruitPieSlice, 
   8: CIGlobals.GrandPiano, 9: CIGlobals.Safe, 10: CIGlobals.BambooCane, 11: CIGlobals.JugglingBalls, 
   12: CIGlobals.Megaphone, 13: CIGlobals.Cupcake, 14: CIGlobals.TrapDoor, 15: CIGlobals.Quicksand, 
   16: CIGlobals.BananaPeel, 17: CIGlobals.Lipstick, 18: CIGlobals.Foghorn, 19: CIGlobals.Aoogah, 
   20: CIGlobals.ElephantHorn, 21: CIGlobals.Opera, 22: CIGlobals.BikeHorn, 23: CIGlobals.Whistle, 
   24: CIGlobals.Bugle, 25: CIGlobals.PixieDust, 26: CIGlobals.FlowerPot, 27: CIGlobals.Sandbag, 
   28: CIGlobals.Anvil, 29: CIGlobals.Geyser, 30: CIGlobals.BigWeight, 31: CIGlobals.StormCloud, 
   32: CIGlobals.WaterGlass, 33: CIGlobals.WaterGun, 34: CIGlobals.FireHose, 35: CIGlobals.SquirtFlower}
gagIdByName = {v:k for k, v in gagIds.items()}
gagData = {CIGlobals.BirthdayCake: {'health': 10, 'damage': 75, 'maxSupply': 3, 'supply': 3}, CIGlobals.TNT: {'damage': 180, 'maxSupply': 3, 'supply': 3}, CIGlobals.FireHose: {'health': 6, 'damage': 30, 'maxSupply': 5, 'supply': 5}, CIGlobals.Geyser: {'damage': 105, 'maxSupply': 1, 'supply': 1}, CIGlobals.BananaPeel: {'damage': 10, 'maxSupply': 10, 'supply': 10}, CIGlobals.Lipstick: {'healRange': (25, 30), 'maxSupply': 5, 'supply': 5}, CIGlobals.Anvil: {'damage': 30, 'maxSupply': 8, 'supply': 8}, CIGlobals.WaterGun: {'health': 2, 'damage': 12, 'maxSupply': 7, 'supply': 7}, CIGlobals.JugglingBalls: {'healRange': (90, 120), 'maxSupply': 3, 'supply': 3}, CIGlobals.Safe: {'damage': 60, 'maxSupply': 7, 'supply': 7}, CIGlobals.WholeCreamPie: {'health': 5, 'damage': 36, 'maxSupply': 7, 'supply': 7}, CIGlobals.WholeFruitPie: {'health': 3, 'damage': 28, 'maxSupply': 10, 'supply': 10}, CIGlobals.SquirtFlower: {'damage': 3, 'maxSupply': 15, 'supply': 15}, CIGlobals.BikeHorn: {'damage': 5, 'maxSupply': 15, 'supply': 15}, CIGlobals.TrapDoor: {'damage': 70, 'maxSupply': 7, 'supply': 7}, CIGlobals.FlowerPot: {'damage': 10, 'maxSupply': 12, 'supply': 12}, CIGlobals.Aoogah: {'damage': 16, 'maxSupply': 7, 'supply': 7}, CIGlobals.Megaphone: {'healRange': (10, 20), 'maxSupply': 7, 'supply': 7}, CIGlobals.Opera: {'damage': 90, 'maxSupply': 1, 'supply': 1}, CIGlobals.BambooCane: {'healRange': (40, 45), 'maxSupply': 4, 'supply': 4}, CIGlobals.Cupcake: {'health': 1, 'damage': 6, 'maxSupply': 15, 'supply': 15}, CIGlobals.Bugle: {'damage': 11, 'maxSupply': 10, 'supply': 10}, CIGlobals.Sandbag: {'damage': 18, 'maxSupply': 10, 'supply': 10}, CIGlobals.WaterGlass: {'health': 2, 'damage': 8, 'maxSupply': 10, 'supply': 10}, CIGlobals.SeltzerBottle: {'health': 5, 'damage': 21, 'maxSupply': 10, 'supply': 10}, CIGlobals.PixieDust: {'healRange': (50, 70), 'maxSupply': 5, 'supply': 5}, CIGlobals.Foghorn: {'damage': 50, 'maxSupply': 3, 'supply': 3}, CIGlobals.GrandPiano: {'damage': 170, 'maxSupply': 3, 'supply': 3}, CIGlobals.StormCloud: {'damage': 60, 'maxSupply': 3, 'supply': 3}, CIGlobals.WeddingCake: {'health': 25, 'damage': 120, 'maxSupply': 3, 'supply': 3}, CIGlobals.ElephantHorn: {'damage': 21, 'maxSupply': 5, 'supply': 5}, CIGlobals.Whistle: {'damage': 7, 'maxSupply': 10, 'supply': 10}, CIGlobals.FruitPieSlice: {'health': 1, 'damage': 10, 'maxSupply': 10, 'supply': 10}, CIGlobals.Quicksand: {'damage': 50, 'maxSupply': 7, 'supply': 7}, CIGlobals.CreamPieSlice: {'health': 2, 'damage': 17, 'maxSupply': 10, 'supply': 10}, CIGlobals.BigWeight: {'damage': 45, 'maxSupply': 7, 'supply': 7}}
InventoryIconByName = {CIGlobals.WholeCreamPie: '**/inventory_creampie', CIGlobals.BirthdayCake: '**/inventory_cake', 
...
ToonUp = 'Toon-Up'
Trap = 'Trap'
TrackIdByName = {Throw: GagType.THROW, Squirt: GagType.SQUIRT, 
   Drop: GagType.DROP, 
   Sound: GagType.SOUND, 
   Lure: GagType.LURE, 
   ToonUp: GagType.TOON_UP, 
   Trap: GagType.TRAP}
TrackColorByName = {ToonUp: (211 / 255.0, 148 / 255.0, 255 / 255.0), Trap: (
...
splatSizes = {CIGlobals.WholeCreamPie: 0.5, 
   CIGlobals.WholeFruitPie: 0.45, CIGlobals.CreamPieSlice: 0.35, 
   CIGlobals.BirthdayCake: 0.6, CIGlobals.WeddingCake: 0.7, 
   CIGlobals.FruitPieSlice: 0.35, CIGlobals.SeltzerBottle: 0.6, 
   CIGlobals.Cupcake: 0.25, CIGlobals.WaterGlass: 0.35, 
   CIGlobals.WaterGun: 0.35, CIGlobals.FireHose: 0.6, 
   CIGlobals.SquirtFlower: 0.2}
