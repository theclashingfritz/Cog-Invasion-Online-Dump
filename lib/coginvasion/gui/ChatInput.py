...
class ChatInput(DirectObject, StateData.StateData):
    ...
    def __init__(self):
        ...
        self.fsm = ClassicFSM.ClassicFSM('chatInput', [
         ...
         State.State('input', self.enterInput, self.exitInput)], 'off', 'off')
    ...
    def enter(self):
        ...
        self.chat_btn = DirectButton(text=('', 'Chat', 'Chat', ''), text_shadow=(0,
                                                                                 0,
                                                                                 0,
                                                                                 1), geom=(
         self.chat_btn_model.find('**/ChtBx_ChtBtn_UP'),
         self.chat_btn_model.find('**/ChtBx_ChtBtn_DN'),
         self.chat_btn_model.find('**/ChtBx_ChtBtn_RLVR')), relief=None, text_scale=0.0525, text_pos=(0,
                                                                                                      -0.08), text_fg=(1,
                                                                                                                       1,
                                                                                                                       1,
                                                                                                                       1), command=self.openChatInput, pos=(0.085,
                                                                                                                                                            0,
                                                                                                                                                            -0.075), scale=1.25, parent=base.a2dTopLeft, extraArgs=[''])
    ...
    def enterInput(self, key, command=None, extraArgs=[]):
        ...
        self.chatBx_close = DirectButton(text=('', 'Cancel', 'Cancel', ''), text_shadow=(0,
                                                                                         0,
                                                                                         0,
                                                                                         1), geom=(
         self.chat_btn_model.find('**/CloseBtn_UP'),
         self.chat_btn_model.find('**/CloseBtn_DN'),
         self.chat_btn_model.find('**/CloseBtn_Rllvr')), relief=None, text_scale=0.0525, text_pos=(0,
                                                                                                   -0.08), text_fg=(1,
                                                                                                                    1,
                                                                                                                    1,
                                                                                                                    1), parent=self.chatBx, pos=(-0.15,
                                                                                                                                                 0,
                                                                                                                                                 -0.0875), scale=1.05, command=self.fsm.request, extraArgs=['idle'])
        self.chatInput = DirectEntry(focus=1, cursorKeys=0, relief=None, geom=None, numLines=3, parent=self.chatBx, pos=(-0.2,
                                                                                                                         0,
                                                                                                                         0.11), scale=0.05, command=command, width=8.6, initialText=key, backgroundFocus=0, extraArgs=extraArgs)
        self.chatBx_send = DirectButton(text=('', 'Say It', 'Say It', ''), text_shadow=(0,
                                                                                        0,
                                                                                        0,
                                                                                        1), geom=(
         self.chat_btn_model.find('**/ChtBx_ChtBtn_UP'),
         ...
         self.chat_btn_model.find('**/ChtBx_ChtBtn_RLVR')), relief=None, text_scale=0.0525, text_pos=(0,
                                                                                                      -0.08), text_fg=(1,
                                                                                                                       1,
                                                                                                                       1,
                                                                                                                       1), parent=self.chatBx, scale=1.05, command=command, pos=(0.18,
                                                                                                                                                                                 0,
                                                                                                                                                                                 -0.0875), extraArgs=[self.chatInput.get()] + extraArgs)
