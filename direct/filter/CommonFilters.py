...
# Embedded file name: direct.filter.CommonFilters
...
class CommonFilters:
    ...
    def setBloom(self, blend=(
 0.3, 0.4, 0.3, 0.0), mintrigger=0.6, maxtrigger=1.0, desat=0.6, intensity=1.0, size='medium'):
        if size == 0:
            size = 'off'
        else:
            if size == 1:
